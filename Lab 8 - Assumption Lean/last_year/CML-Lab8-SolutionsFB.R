...
# Load data
file_path <- "C:/Users/fbertoia/OneDrive - UGent/Desktop/PhD Statistical Data Analysis/1. Causal Machine Learning - Stijn Vanstelaandt/Labs/Lab 8 - Assumption-Lean Regression/KingCounty2001.data"

file_path2 <- "C:/Users/feder/OneDrive - UGent/Desktop/PhD Statistical Data Analysis/1. Causal Machine Learning - Stijn Vanstelaandt/Labs/Lab 8 - Assumption-Lean Regression/KingCounty2001.data"
...
q.cv <- CV.SuperLearner(Y = Y, X = L, SL.library = SL.library, family = "binomial", cvControl = 2, innercvControl = list(V = 5))
p.cv <- CV.SuperLearner(Y = A, X = L, SL.library = SL.library, family = "binomial", V = 5)
...
q.cv <- CV.SuperLearner(Y = Y, X = L, SL.library = SL.library2, family = "binomial", cvControl = 2, innercvControl = list(V = 5))
p.cv <- CV.SuperLearner(Y = A, X = L, SL.library = SL.library2, family = "binomial", cvControl = 2, innercvControl = list(V = 5))
