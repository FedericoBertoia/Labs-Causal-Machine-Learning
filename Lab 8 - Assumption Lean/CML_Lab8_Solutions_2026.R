...
##
##  Weighted mean of each covariate X:
##    mu_w(X) = E[(A - pi_hat)^2 * X] / E[(A - pi_hat)^2]
##  SE derived from the EIF of this functional.
#############################################
...
##
##  Regress tilde_Y on (A - pi_hat) to recover beta on the log scale;
##  exponentiate for the risk ratio.
################################################################################
